...
-
"""
test_module_star_import()
test_module_from_import()
test_module_import_affects_current_namespace()
test_module_is_an_object()
test_module_type()
test_module_usage_multiple()
test_module_usage_needs_import()
test_module_why_from_import_is_a_bad_idea()
test_module_without_import()
test_modules_are_cached()