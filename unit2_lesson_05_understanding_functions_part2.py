...
def test_function_call_with_keyword_arguments():
    assert [10, 15, 3, 4] == demo(10,15) #TypeError: demo() missing 1 required positional argument: 'second'
    assert [10, 20, 3, 4] == demo(10, 20)
    assert [10, 20, 30, 4] == demo(10, 20, 30)
    assert [10, 20, 3, 4] == demo(10,second=20) #demo() missing 1 required positional argument: 'first'
    ...
    assert [10, 20, 3, 4] == demo(10,second=20)  # incorrect
...
def simple_format(format, *args):
    ...
    for i in range(0,len(args)):
        format=format.replace("%"+str(i),r"{"+str(i)+"}")
