...
def get_encoding_dict():
    ...
    dict2=dict(zip(string.ascii_uppercase,range(1,27)))
    dict1.update(dict2)
    return dict1 #(zip(string.ascii_lowercase,range(1,27))).update(dict(zip(string.ascii_uppercase,range(1,27))))
...
def get_consonents(input):
    ...
    return set(str.lower(input))-set(VOWEL_SET)
